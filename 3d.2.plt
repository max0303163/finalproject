...
set yrange [ -10.0000 : 100.000 ] noreverse nowriteback
set y2range [ * : * ] noreverse nowriteback
set zlabel "" 
set zlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set zrange [ -10.0000 : 100.000 ] noreverse nowriteback
set cblabel "" 
...
set rmargin  -1
set tmargin  -1
set locale "Chinese (Traditional)_Taiwan.950"
...
GNUTERM = "wxt"
i = 2
splot '3d.'.i.'.txt' u 1:2:3:($4*3000):($5*3000):($6*3000) with vectors notitle,'3d.'.i.'.txt' u 1:2:3:($7*500000):($8*500000):($9*500000) w vectors notitle
#    EOF
